...
warez = [
    ['group', 'name', 'desc', 'id'],
    ['Одежда', 'Куртка', 'Описание "Куртка"', 'cloth_coat'],
    ['Одежда', 'Платье', 'Описание "Платье"', 'cloth_dress'],
    ['Обувь', 'Ботинки', 'Описание "Ботинки"', 'shoes_boot'],
    ['Обувь', 'Кроссовки', 'Описание "Кроссовки"', 'shoes_sneak'],
]
